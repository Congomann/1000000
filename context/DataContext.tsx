...
export const DataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const [companySettings, setCompanySettings] = useState<CompanySettings>({
      ...
      customProducts: [
        { id: 'life', title: 'Life Insurance', description: "Ensure your family's financial security with our comprehensive life insurance plans.", features: ['Term Life', 'Whole Life', 'Universal Life', 'Final Expense'], image: "https://picsum.photos/600/400?random=1", icon: 'ShieldCheck', color: 'blue', link: '/products?category=life-insurance', isHidden: false, order: 0 },
        { id: 'real-estate', title: 'Real Estate', description: "Specialized coverage for real estate investors, landlords, and property managers.", features: ['Loss of Rent', 'Vacant Property', 'Multi-family Dwelling', 'Renovation Risk'], image: "https://picsum.photos/600/400?random=3", icon: 'HomeIcon', color: 'amber', link: '/products?category=real-estate', isHidden: false, order: 1 },
        { id: 'mortgage', title: 'Mortgage Lending & Refinance', description: "Transform your mortgage into a strategic financial tool with personalized lending and refinance solutions.", features: ['Lower Monthly Payments', 'Cash-Out Refinance', 'Debt Consolidation', 'Strategic Mortgage Planning'], image: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80", icon: 'Landmark', color: 'cyan', link: '/products?category=mortgage-lending-refinance', isHidden: false, order: 2 },
        { id: 'business', title: 'Business & Professional Liability', description: "Protect your business assets, operations, and professional reputation with tailored commercial and E&O packages.", features: ['General Liability', "Worker's Comp", 'Professional Liability (E&O)', 'Cyber Liability'], image: "https://picsum.photos/600/400?random=2", icon: 'Briefcase', color: 'purple', link: '/products?category=business-insurance', isHidden: false, order: 3 },
        { id: 'auto', title: 'Auto Insurance', description: "Comprehensive auto coverage for personal vehicles and commercial fleets to keep you moving.", features: ['Personal Auto', 'Commercial Fleet', 'Liability Coverage', 'Collision & Comprehensive'], image: "https://picsum.photos/600/400?random=6", icon: 'Truck', color: 'red', link: '/products?category=auto-insurance', isHidden: false, order: 4 },
        { id: 'securities', title: 'Securities & Investment Advisory', description: "Navigating financial securities, series licensing, and providing fiduciary retirement planning strategies.", features: ['Series 6, 7, 63 Support', 'Fiduciary Planning', 'Portfolio Management', 'Wealth Management Compliance'], image: "https://images.unsplash.com/photo-1611974765270-ca12586343bb?ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80", icon: 'BarChart3', color: 'emerald', link: '/products?category=securities', isHidden: false, order: 5 }
      ]
  });
